...
module.exports = {
    apps: [
        {
            // name: cwd + "-" + "codeBridgeLandingApp",
            script: 'src/',
            instance_var: 'INSTANCE_ID',
            appendEnvToName: true,
            // Standard Output (console.log) will go here
            //out_file: "/home/ubuntu/app/logs/codeBridgeLandingAppstg-out.log",
            // Error Output (console.error) will go here
            //error_file: "/home/ubuntu/app/logs/codeBridgeLandingApp-stg-error.log",
